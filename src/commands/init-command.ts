...
import { buildRulesMd, buildNoesisIndexMd, RULES_START, RULES_END } from "../shared/prompt-surface.js";
...
// ============================================================================
// RULES.md BUILDER — generated from prompt-surface metadata
// ============================================================================

export const RULES_MD: string = buildRulesMd();

// ============================================================================
// OBSIDIAN INDEX BUILDER — generated from prompt-surface metadata
// ============================================================================

const NOESIS_INDEX_MD: string = buildNoesisIndexMd();
